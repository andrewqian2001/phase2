...
public class EditTradeModal extends JDialog implements ActionListener {
	...
	public EditTradeModal(String tradeID, String trader, boolean isTraderFirstUser, Font regular, Font bold,
			Font italic, Font boldItalic) throws IOException {
	...
	private JPanel setTradeEditsPanel() {
		...
		JPanel meetingDatePanel = setMeetingDatePanel();
		...
		tradeEditsPanel.add(meetingDatePanel);
	...
	private JPanel setMeetingDatePanel() {
		JPanel meetingDatePanel = new JPanel();
		meetingDatePanel.setBackground(bg);
		meetingDatePanel.setPreferredSize(new Dimension(700,125)); // fix
